        ...
        try {
            for (RequestEntry entry : operations)
                switch (entry.getOperation()) {
                    case add -> Repository.add(gitter, entry.getPayload().toRepositoryResource());
                    case update -> Repository.update(gitter, entry.getPayload().toRepositoryResource());
                    case remove -> Repository.remove(gitter, entry.getPayload().toRepositoryResource());
                }
