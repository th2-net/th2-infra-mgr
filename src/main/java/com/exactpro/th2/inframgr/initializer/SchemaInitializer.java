...
public class SchemaInitializer {
    ...
    private static Secret makeCopy(Secret secret) {
        return makeCopy(secret, secret.getMetadata().getName());
    }

    private static Secret makeCopy(Secret secret, String secretName) {
        ...
        secretCopy.getMetadata().setName(secretName);
